    ...
    public static class EmailHandler
    {
        ...
        public static bool SendVerificationMail(string email, string username, string verifyCode)
        {
            try
            {
                ...
                ConsoleLog.WriteIOGeneral("Sending a verification email to " + email + "...");
            ...
            {
                ConsoleLog.WriteErrorGeneral("Error occurred while attempting to deliver a verification email to " + email);
